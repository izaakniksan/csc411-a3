...
\captionof{figure}{Learning Curves for a Logistic Regression Classifier on Training and Validation Sets. alpha=0.01, lambda=10}
\includegraphics[width=13cm, height=8cm]{latex_images/part4_learningcurve_withval.png} 
\captionof{figure}{Learning Curves for a Logistic Regression Classifier on Training and Validation Sets. alpha=0.01, lambda=0.8}
\end{center}
\\
\textbf{Part 5)}\\
